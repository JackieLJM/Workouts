...
var bubbleImagePath = './bg.png';// DO NOT EDIT BENEATH THIS
...
_10.setAttribute("style","text-align: center; z-index: 99999; position: absolute; top: "+_f+"px ; left: "+_e+"px ; background: url("+ bubbleImagePath +") no-repeat; width: 356px; height: 356px; padding: 0; margin: 0;");
}
if (BrowserDetect.browser == 'Safari' || BrowserDetect.browser == 'Konqueror' ) {var _height = _f;
    
_10.setAttribute("style","text-align: center; z-index: 99999; position: absolute; top: "+ _height +"px ; left: "+_e+"px ; background: url("+ bubbleImagePath +") no-repeat; width: 356px; height: 356px; padding: 0; margin: 0;");
    
}
_10.innerHTML='<div class="previewinfo"><iframe src="'+_d+'" id="planeFrame" class="et-p-frame" frameborder="0" scrolling="no"></iframe></div>';
}
